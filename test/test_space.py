...
class TestSpace(unittest.TestCase):
    ...
    def test_next_params(self):
        ...
        for i in range(100):
            assert(space.next_params(history=[("Model", None), ("x2", None), ("x2_p1", "c")])[0] == "x2_p2")
            assert(space.next_params(history=[("Model", None), ("x2", None), ("x2_p1", "a")])[0] == "x2_p2")
            assert(space.next_params(history=[("Model", None), ("x2", None)])[0] == "x2_p1")
            assert(space.next_params(history=[("Model", None), ("x1", None)])[0] in ["x1_p1", "x1_p2"])
            assert(space.next_params(history=[("Model", None), ("x1", None), ("x1_p2", 5)])[0] in ["x1_p1", "x1_p2"])
