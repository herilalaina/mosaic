...
class Env_preprocessing(Env_sklearn):
    def __init__(self, X, y, aggreg_score=np.mean):
        ...
        self.terminal_state = ["selectKBest__k", "PCA__n_components", "identity",
                               "gaussianRandomProjection__n_components", "latentDirichletAllocation__learning_decay"]
    ...
    def calculate(self, moves):
        ...
        pipeline = [(name_estimator, estimator),
                    ("passiveAggressiveClassifier",
                     PassiveAggressiveClassifier(warm_start=True, class_weight="balanced", n_jobs=-1, max_iter=50))]
