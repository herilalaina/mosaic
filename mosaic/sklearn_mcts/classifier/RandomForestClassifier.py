...
class Space_randomForestClassifier(Space_preprocessing):
    def __init__(self):
        ...
        randomForestClassifier__max_features = randomForestClassifier__criterion.add_child(
            "randomForestClassifier__max_features")
        randomForestClassifier__max_depth = randomForestClassifier__max_features.add_child(
            "randomForestClassifier__max_depth")
        randomForestClassifier__min_samples_split = randomForestClassifier__max_depth.add_child(
            "randomForestClassifier__min_samples_split")
        randomForestClassifier__n_estimators = randomForestClassifier__min_samples_split.add_child(
...
class Env_randomForestClassifier(Env_preprocessing):
    def __init__(self, X, y, aggreg_score=np.mean, ressource=2, cv=3, info=None):
